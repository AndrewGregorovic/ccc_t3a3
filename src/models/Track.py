...
class Track(db.Model):
    ...
    href = db.Column(db.String(), nullable=False, default="http://spotify.com/track/<id>")
    name = db.Column(db.String(), nullable=False)
    popularity = db.Column(db.Integer, nullable=False, default=0)
    preview_url = db.Column(db.String(), nullable=False, default="http://spotify.com/track/<id>/preview")
