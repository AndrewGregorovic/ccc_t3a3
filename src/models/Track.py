...
class Track(db.Model):
    ...
    href = db.Column(db.String(), nullable=False, default=f"http://spotify.com/track/{id}")
    name = db.Column(db.String(), nullable=False)
    popularity = db.Column(db.Integer, nullable=False, default=0)
    preview_url = db.Column(db.String(), nullable=False, default=f"http://spotify.com/track/{id}/preview")
    track_number = db.Column(db.Integer, nullable=False)
    object_type = db.Column(db.String(20), nullable=False, default="track")
    uri = db.Column(db.String(), nullable=False, default=f"spotify:track:{id}")
